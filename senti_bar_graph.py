...
if __name__ == "__main__" :
    ...
    plt.xticks(range(len(ctrpos)),list(ctrpos.keys()),rotation=90)
    plt.show()
    ...
    plt.xticks(range(len(ctrneg)),list(ctrneg.keys()),rotation=90)
    plt.show()
    ...
    plt.xticks(range(len(ctrneu)),list(ctrneu.keys()),rotation=90)
    plt.show()
